package com.wysteria.colourbottle.common.rendering;
...
public class PlaneRenderer {
  ...
  private static final int INITIAL_INDEX_BUFFER_SIZE_BYTES = BYTES_PER_SHORT * INDICES_PER_BOUNDARY_VERT * INDICES_PER_BOUNDARY_VERT * INITIAL_BUFFER_BOUNDARY_VERTS;
  ...
  private final float[] planeColor = new float[] {1f, 1f, 1f, 0.2f};
  private final float[] planeColor_2 = new float[] {0f, 0f, 0f, 0f};
